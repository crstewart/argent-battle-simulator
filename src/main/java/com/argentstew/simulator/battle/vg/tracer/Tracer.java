...
public class Tracer {
    ...
    public static Fighter get() {
        ...
        FighterStats stats = FighterStats.builder().strength(4.5).toughness(4).dexterity(7.5).aim(8.5)
                .agility(8).speed(6.5).intellect(5.5).willpower(6).size(4.5).weight(4.5).build();
