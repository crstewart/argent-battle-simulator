...
public class Kirby {
    ...
    public static Fighter get() {
        ...
        FighterStats stats = FighterStats.builder().strength(4.5).toughness(8).dexterity(4).aim(4.5)
        ...
        return Fighter.builder().name(NAME).hp(130).maxHp(130).mp(50).maxMp(50).xStrikeMeter(0)
