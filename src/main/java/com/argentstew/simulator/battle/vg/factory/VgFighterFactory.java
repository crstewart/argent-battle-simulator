...
public class VgFighterFactory implements FighterFactory {
    ...
    public static final List<String> FIGHTERS = Arrays.asList(Mario.NAME, Luigi.NAME, Bowser.NAME, Peach.NAME,
            ...
            Rathalos.NAME, Shadow.NAME, SweetTooth.NAME, Aloy.NAME, Sylvanas.NAME, Deathwing.NAME, Widowmaker.NAME,
            SamFisher.NAME);
    ...
    public Fighter getFighter(String name) {
        switch(name) {
            ...
            case Sylvanas.NAME:
                return Sylvanas.get();
            case Deathwing.NAME:
                return Deathwing.get();
            case Widowmaker.NAME:
                return Widowmaker.get();
            case SamFisher.NAME:
                return SamFisher.get();
            default:
